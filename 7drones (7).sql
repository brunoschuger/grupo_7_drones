...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-09-2023 a las 21:03:05
...
(3, 'Mavic Mini 2 ', 15000.00, 18000.00, 'Los drones DJI se caracterizan por la mejor tecnología al servicio de cada tipo de usuario y escenario de disparo. Si estás buscando un dron para principiantes, un dron profesional o solamente querés estar actualizado con las últimas innovaciones, es hora de elegir a esta marca.\r\n\r\nDiseñado para vivir una experiencia única\r\nSu velocidad máxima es de 16 m/s, lo que te brindará la posibilidad de ahorrar tiempo en los desplazamientos.\r\nA través de su cámara 4K obtendrás imágenes de gran resolución y calidad, y podrás registrar todo su recorrido. Gracias a su sistema GPS conseguirás alcanzar largas distancias y conquistar espacios con independencia.\r\nIncluye 1 batería, que abastecerán al drone de la energía suficiente para funcionar. Al finalizar el trayecto, podrás recargarla de manera fácil y cómoda.\r\n\r\nAl infinito y más allá\r\nEste drone aéreo te permitirá ver absolutamente todo desde las alturas. Asegurate de encontrar una plataforma de vuelo que te permita trabajar con comodidad y preparate para volar.\r\n', 32, 26, 4, 1, 1, '/images/uploads/1690152664886_mavic-mini-2.jpg', '/images/uploads/1690164930439_mavicmini2.jpg'),
...
(2, 'leitoxx', '$2b$12$j1nE5qnKtL.bOLhtYEgmBuoCj9PpqD2FDZ7hiFUuoH.KpSKO0cEAu', '/images/uploads/profile-imgs/1692492483319_leitoxx.jpg', 'leolopez@7drones.com.ar', 1, 'Leo', 'Lopez ', '073f5d05-ce46-4722-a0d3-87b75613777d'),
